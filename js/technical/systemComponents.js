var systemComponents = {
	...
	'overlay-head': {
		...
		<!--<span v-if="!inChallenge('ra', 11)"  class="overlayThing">
			<br>You are currently in V's Reality.<br>
		</span>
		<span v-if="inChallenge('ra', 11)"  class="overlayThing">
			<br>You are currently in V's and Ra's Dual Reality.<br>
			<br>You are currently in Recognition Therapy in V's Reality.<br>
		</span>-->
